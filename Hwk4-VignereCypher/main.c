...
int main() {
    ...
    if (new_pid > 0) {   // Parent process
        ...
        write(parent_to_child[1], fileName, strlen(fileName)+1); // do a single write function + NULL character
        ...
        write(child_to_parent[1], resultFileName, strlen(resultFileName)+1);
